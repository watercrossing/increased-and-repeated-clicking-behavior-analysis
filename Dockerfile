# Reproducible environment for the analysis in the IEEE S&P 2027 paper.
#
...
#                    ~40 second build into a ~45 minute one.
...
# R packages required by Repeat_clicker_analysis_5.Rmd, plus knitr/rmarkdown
